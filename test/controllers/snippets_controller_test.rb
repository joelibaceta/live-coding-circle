...
class SnippetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post snippets_url, params: { snippet: { code: @snippet.code, id: @snippet.id, language: @snippet.language, stack: @snippet.stack, title: @snippet.title } }
    end
  ...
  test "should update snippet" do
    patch snippet_url(@snippet), params: { snippet: { code: @snippet.code, id: @snippet.id, language: @snippet.language, stack: @snippet.stack, title: @snippet.title } }
